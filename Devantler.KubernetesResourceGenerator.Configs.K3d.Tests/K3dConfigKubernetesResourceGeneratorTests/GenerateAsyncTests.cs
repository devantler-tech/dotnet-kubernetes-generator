...
namespace Devantler.KubernetesResourceGenerator.Configs.K3d.Tests.K3dConfigKubernetesResourceGeneratorTests;

/// <summary>
/// Tests for <see cref="K3dConfigKubernetesResourceGenerator"/>.
/// </summary>
public class GenerateAsyncTests
{
  ...
  public async Task GenerateAsync_WithAllPropertiesSet_ShouldGenerateAValidFullK3dConfigFile()
  {
    ...
    await K3dConfigKubernetesResourceGenerator.GenerateAsync(config, filePath);
