...
namespace Devantler.KubernetesGenerator.Configs.K3d.Tests.K3dConfigResourceGeneratorTests;
...
public class GenerateAsyncTests
{
  ...
  /// <summary>
  /// Tests that <see cref="K3dConfigKubernetesGenerator.GenerateAsync(K3dConfig, string, CancellationToken)"/> generates a valid K3d cluster configuration with all properties set.
  /// </summary>
  [Fact]
  ...
  /// <summary>
  /// Tests that <see cref="K3dConfigKubernetesGenerator.GenerateAsync(K3dConfig, string, CancellationToken)"/> generates a valid K3d cluster configuration with minimal properties set.
  /// </summary>
  /// <returns></returns>
  [Fact]
