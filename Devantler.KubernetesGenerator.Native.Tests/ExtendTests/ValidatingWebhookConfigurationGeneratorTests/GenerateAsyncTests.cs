using Devantler.KubernetesGenerator.Native.Extend;
using k8s.Models;

namespace Devantler.KubernetesGenerator.Native.Tests.ExtendTests.ValidatingWebhookConfigurationGeneratorTests;
...
public class GenerateAsyncTests
{
  ...
  public async Task GenerateAsync_WithAllPropertiesSet_ShouldGenerateAValidValidatingWebhookConfiguration()
  {
    ...
    // Act
    string outputPath = Path.Combine(Path.GetTempPath(), "validating-webhook-configuration.yaml");
