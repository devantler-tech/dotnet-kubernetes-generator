...
namespace Devantler.KubernetesGenerator.Native.Tests.AuthorizationTests.SelfSubjectAccessReviewGeneratorTests;
...
public class GenerateAsyncTests
{
  ...
  public async Task GenerateAsync_WithAllPropertiesSet_ShouldGenerateAValidSelfSubjectAccessReview()
  {
    ...
    // Act
    string outputPath = Path.Combine(Path.GetTempPath(), "self-subject-access-review.yaml");
