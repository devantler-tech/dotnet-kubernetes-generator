using Devantler.KubernetesGenerator.Native.Authentication;
using k8s.Models;

namespace Devantler.KubernetesGenerator.Native.Tests.AuthenticationTests.CertificateSigningRequestGeneratorTests;
...
public class GenerateAsyncTests
{
  ...
  public async Task GenerateAsync_WithAllPropertiesSet_ShouldGenerateAValidCertificateSigningRequest()
  {
    ...
    // Act
    string outputPath = Path.Combine(Path.GetTempPath(), "csr.yaml");
