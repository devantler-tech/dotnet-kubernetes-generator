...
namespace Devantler.KubernetesGenerator.Native.Tests.WorkloadTests.DeploymentGeneratorTests;
...
public class GenerateAsyncTests
{
  ...
  public async Task GenerateAsync_WithAllPropertiesSet_ShouldGenerateAValidDeployment()
  {
    ...
    // Act
    string outputPath = Path.Combine(Path.GetTempPath(), "deployment.yaml");
